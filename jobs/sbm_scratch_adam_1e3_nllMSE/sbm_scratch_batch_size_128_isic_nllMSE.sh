...
#SBATCH --job-name=sbm_scratch_batch_size_512_adam_1e3_isic_nllMSE
...
python sbm_scratch_batch_size_512_adam_1e3_ISIC_nllMSE.py


wait

echo "---------------------------------------<Copying weights>------------------------------------"
cp -r logs/sbm_scratch_adam_1e3_nllMSE/isic ~/proj_cdf2/logs/sbm_scratch_adam_1e3_nllMSE
